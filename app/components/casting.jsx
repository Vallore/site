    ...
    <>
      ...
      <div className="p-4 bg-gray-100">
        ...
        <div className="flex gap-4">
          ...
          <button className="flex items-center justify-center border border-yellow-800 text-xs hover:bg-yellow-600 hover:text-white text-yellow-800 py-2.5 px-4 rounded-lg font-bold">
